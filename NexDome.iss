...
#define MyAppName "NexDome X2 PlugIn"
...
Source: "domelist NexDome.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 NexDome.txt"
; 32 bits
Source: "libNexDome\Win32\Release\libNexDome.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
...
; 64 bits
Source: "libNexDome\x64\Release\libNexDome.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "NexDome.ui";                               DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
