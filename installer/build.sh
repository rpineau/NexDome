...
pkgbuild --root ROOT --identifier org.rti-zone.NexDome_X2 --sign "$installer_signature" --scripts Scripts --version 1.0 NexDome_X2.pkg
pkgutil --check-signature ./NexDome_X2.pkg
else
pkgbuild --root ROOT --identifier org.rti-zone.NexDome_X2 --scripts Scripts --version 1.0 NexDome_X2.pkg
fi
